...
export default function GameSession() {
  ...
  return (
    <>
      ...
      {gameOver && (
        <div role="alertdialog" className="  fixed top-0 left-0 w-[100vw] h-[100vh] bg-gray-600/70 flex items-center justify-center">
          <section
          role="alert"
        ...
        >
          ...
          <Button label="Play again" className="!w-fit px-10 text-xl" onClick={handlePlayAgain} />
